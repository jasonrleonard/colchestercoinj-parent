package com.google.colchestercoin.tools;
...
public class BuildCheckpoints {
    public static void main(String[] args) throws Exception {
        ...
        final FileOutputStream fileOutputStream = new FileOutputStream("colchestercoin-checkpoints", false);
        ...
        CheckpointManager manager = new CheckpointManager(params, new FileInputStream("colchestercoin-checkpoints"));
