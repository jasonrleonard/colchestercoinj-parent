 ...
 *
 * <ul>
 * <li>{@code colchestercoin:<address>}</li>
 * <li>{@code colchestercoin:<address>?<name1>=<value1>&<name2>=<value2>} with multiple
...
public class ColchestercoinURI {
    ...
    public static final String BITCOIN_SCHEME = "colchestercoin";
    ...
    public ColchestercoinURI(@Nullable NetworkParameters params, String input) throws ColchestercoinURIParseException {
        ...
        // blockchain.info generates URIs of non-BIP compliant form colchestercoin://address?....
        // We support both until Ben fixes his code.
        
        // Remove the colchestercoin scheme.
        // (Note: getSchemeSpecificPart() is not used as it unescapes the label and parse then fails.
        // For instance with : colchestercoin:129mVqKUmJ9uwPxKJBnNdABbuaaNfho4Ha?amount=0.06&label=Tom%20%26%20Jerry
        // the & (%26) in Tom and Jerry gets interpreted as a separator and the label then gets parsed
        // as 'Tom ' instead of 'Tom & Jerry')
        String schemeSpecificPart;
        if (input.startsWith("colchestercoin://")) {
