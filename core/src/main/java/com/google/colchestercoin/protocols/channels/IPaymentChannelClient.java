...
package com.google.colchestercoin.protocols.channels;

import com.google.colchestercoin.core.InsufficientMoneyException;
import com.google.common.util.concurrent.ListenableFuture;
import org.colchestercoin.paymentchannel.Protos;
...
public interface IPaymentChannelClient {
     ...
     * {@link PaymentChannelClient.ClientConnection#destroyConnection(com.google.colchestercoin.protocols.channels.PaymentChannelCloseException.CloseReason)} or
     ...
     * {@link PaymentChannelClient.ClientConnection#destroyConnection(com.google.colchestercoin.protocols.channels.PaymentChannelCloseException.CloseReason)}
    ...
    interface ClientConnection {
         ...
         * {@link com.google.colchestercoin.protocols.channels.PaymentChannelClient#connectionClosed()} should be called immediately. In the case of messages which
         ...
         *
         * <p>Called while holding a lock on the {@link com.google.colchestercoin.protocols.channels.PaymentChannelClient} object - be careful about reentrancy</p>
         */
         ...
         * {@link com.google.colchestercoin.protocols.channels.PaymentChannelClient#connectionClosed()} event should be generated immediately after this call.</p>
         *
         * <p>Called while holding a lock on the {@link com.google.colchestercoin.protocols.channels.PaymentChannelClient} object - be careful about reentrancy</p>
         *
         ...
         *               {@link com.google.colchestercoin.protocols.channels.PaymentChannelCloseException.CloseReason#CLIENT_REQUESTED_CLOSE} as "unrecoverable error" and all others as
         *               "try again once and see if it works then"
         */
        void destroyConnection(PaymentChannelCloseException.CloseReason reason);

        /**
         * {@link com.google.colchestercoin.protocols.channels.PaymentChannelClient#incrementPayment(java.math.BigInteger)}
         * may be called at will.</p>
         *
         * <p>Called while holding a lock on the {@link com.google.colchestercoin.protocols.channels.PaymentChannelClient}
