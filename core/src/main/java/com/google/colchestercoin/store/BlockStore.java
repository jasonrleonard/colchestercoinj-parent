...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link com.google.colchestercoin.core.BlockChain#getChainHead()}
     * or perhaps {@link com.google.colchestercoin.core.BlockChain#getBestChainHeight()} which will run in constant time and
