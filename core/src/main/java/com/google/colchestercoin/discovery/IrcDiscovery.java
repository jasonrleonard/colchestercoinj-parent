...
package com.google.colchestercoin.discovery;
...
public class IrcDiscovery implements PeerDiscovery {
     ...
     * disconnecting.
     *
     * @param channel The IRC channel to join, either "#colchestercoin" or "#bitcoinTEST3" for the production and test networks
     *                respectively.
     */
