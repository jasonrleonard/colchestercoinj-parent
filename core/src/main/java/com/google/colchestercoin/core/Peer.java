...
public class Peer {
    ...
    private static class GetDataRequest {
        ...
        // a nasty hack that relies on the fact that colchestercoin-qt is single threaded and processes messages in order.
     ...
     * Once the pong is received the value returned by {@link com.google.colchestercoin.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.google.colchestercoin.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.google.colchestercoin.core.Peer#ping()} has never
