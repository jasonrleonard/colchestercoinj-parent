 ...
 * the lightweight SPV mode, a {@link com.google.colchestercoin.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link com.google.colchestercoin.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to the
...
public abstract class AbstractBlockChain {
    ...
    private void checkTestnetDifficulty(StoredBlock storedPrev, Block prev, Block next) throws VerificationException, BlockStoreException {
        ...
        // There is an integer underflow bug in colchestercoin-qt that means mindiff blocks are accepted when time
        // goes backwards.
