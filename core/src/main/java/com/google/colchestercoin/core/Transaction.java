...
public class Transaction extends ChildMessage implements Serializable {
     ...
     */
    public static final BigInteger REFERENCE_DEFAULT_MIN_TX_FEE = BigInteger.valueOf(2000000);
    ...
    // These are serialized in both colchestercoin and java serialization.
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, com.google.colchestercoin.script.Script, ECKey, com.google.colchestercoin.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], com.google.colchestercoin.core.Transaction.SigHash, boolean)}
