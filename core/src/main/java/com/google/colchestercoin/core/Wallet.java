...
import com.google.colchestercoin.wallet.DefaultRiskAnalysis;
import com.google.colchestercoin.wallet.RiskAnalysis;
import com.google.colchestercoin.core.TransactionConfidence.ConfidenceType;
import com.google.colchestercoin.core.WalletTransaction.Pool;
import com.google.colchestercoin.crypto.KeyCrypter;
import com.google.colchestercoin.crypto.KeyCrypterException;
import com.google.colchestercoin.crypto.KeyCrypterScrypt;
import com.google.colchestercoin.script.Script;
import com.google.colchestercoin.script.ScriptBuilder;
import com.google.colchestercoin.script.ScriptChunk;
...
import com.google.colchestercoin.utils.ListenerRegistration;
import com.google.colchestercoin.utils.Threading;
import com.google.colchestercoin.wallet.*;
...
import static com.google.colchestercoin.core.Utils.bitcoinValueToFriendlyString;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.colchestercoin.wallet.WalletFiles.Listener)}
...
public class Wallet implements Serializable, BlockChainListener, PeerFilterProvider {
    ...
    public static class SendRequest {
         ...
         * (its value is ignored and set to {@link com.google.colchestercoin.core.Wallet#getBalance()} - the fees required
         ...
         *
         * <p>Once {@link Wallet#completeTx(com.google.colchestercoin.core.Wallet.SendRequest)} is called, this is set to the
        ...
        /**
         * If not null, the {@link com.google.colchestercoin.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
    ...
    public Transaction createSend(SendRequest req) throws InsufficientMoneyException {
        completeTx(req);
        return req.tx;
    }
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.google.colchestercoin.wallet.WalletFiles.Listener)}
     ...
     * of {@link com.google.colchestercoin.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(com.google.colchestercoin.crypto.KeyCrypter,
     ...
     * {@link com.google.colchestercoin.crypto.KeyCrypterScrypt}.
     *
        ...
        try {
            ...
            for (ECKey key : keychain) {
                if (key.isEncrypted()) {
                    ...
                    // (all colchestercoin controlled by that private key is lost forever).
    ...
    /**
     * <p>Convenience wrapper around {@link Wallet#addNewEncryptedKey(com.google.colchestercoin.crypto.KeyCrypter,
     ...
     * you can use {@link com.google.colchestercoin.utils.Threading#waitForUserCode()} to block until the future had a
     ...
     */
    public void setTransactionBroadcaster(@Nullable com.google.colchestercoin.core.TransactionBroadcaster broadcaster) {
        lock.lock();
        try {
