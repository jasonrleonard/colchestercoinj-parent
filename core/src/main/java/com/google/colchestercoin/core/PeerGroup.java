...
import com.google.colchestercoin.core.Peer.PeerHandler;
...
public class PeerGroup extends AbstractIdleService implements TransactionBroadcaster {
    ...
    private class PeerStartupListener implements Peer.PeerLifecycleListener {
        ...
        public void onPeerDisconnected(Peer peer) {
            ...
            log.info("Peer Disconnected: " + peer.getPeerVersionMessage());
    ...
    // pipeline with the colchestercoin serializer ({@code TCPNetworkConnection}) downstream
...
*/            // Link the peer to the memory pool so broadcast transactions have their confidence levels updated.
     ...
     * peers. By using this with {@link com.google.colchestercoin.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.google.colchestercoin.core.PeerGroup#getMaxConnections()} returns is used.
     * @return
     */
    ...
    /**
     * See {@link com.google.colchestercoin.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link com.google.colchestercoin.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.google.colchestercoin.core.Peer#ping()}.
     */
