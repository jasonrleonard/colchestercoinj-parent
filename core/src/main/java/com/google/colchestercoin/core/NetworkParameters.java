...
import com.google.colchestercoin.params.TestNet2Params;
...
import static com.google.colchestercoin.core.Utils.COIN;
...
public abstract class   NetworkParameters implements Serializable {
    ...
    public static final String ID_MAINNET = "org.colchestercoin.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = "org.colchestercoin.test";
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "com.google.colchestercoin.unittest";
    ...
    /**
     * First byte of a base58 encoded address. See {@link com.google.colchestercoin.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link com.google.colchestercoin.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link com.google.colchestercoin.core.AlertMessage}s. You can use {@link com.google.colchestercoin.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
